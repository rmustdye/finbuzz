...
It is the broadest retail search term for the AI investment theme. Choosing a
broad term was deliberate: if even a general sentiment signal does not predict
...
It is a verifiable integrity gate.
...
### Why add the "five beats, three drops" observation?
Across the full analysis period (Aug 2025 to Aug 2026), NVIDIA beat
earnings estimates five consecutive quarters. The stock fell after three
of those five beats. If search attention (which spikes during earnings
coverage) predicted price direction, every beat should produce a rally.
The inconsistent direction proves that even the strongest attention
signal (earnings media coverage) does not reliably predict price. This
observation was added after verifying the Aug 26, 2026 Q2 FY2027 results
against multiple sources (SEC 8-K, NVIDIA Newsroom, CNBC, Yahoo Finance).

## Design decisions

### Why not the default Claude palette?
AI-generated designs cluster around recognisable looks: cream+terracotta,
dark+acid-green, or broadsheet+hairlines. FinBuzz uses Newsreader (editorial
serif), Source Sans 3 (professional sans), JetBrains Mono (data), with a
palette of warm paper, institutional blue, burnt sienna, and muted teal.
The design rationale is documented because "why does it look like this?"
...
- "AI stocks" measures interest in a theme, not NVDA specifically.
  Ticker-specific terms ("NVDA stock") may show different results.
